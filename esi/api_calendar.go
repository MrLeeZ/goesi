...
func (r ApiPutCharactersCharacterIdCalendarEventIdRequest) Execute() (interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return interface{}
func (a *CalendarAPIService) PutCharactersCharacterIdCalendarEventIdExecute(r ApiPutCharactersCharacterIdCalendarEventIdRequest) (interface{}, *http.Response, error) {
	var (
