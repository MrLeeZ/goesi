...
func (r ApiDeleteCharactersCharacterIdContactsRequest) Execute() (interface{}, *http.Response, error) {
...
//  @return interface{}
func (a *ContactsAPIService) DeleteCharactersCharacterIdContactsExecute(r ApiDeleteCharactersCharacterIdContactsRequest) (interface{}, *http.Response, error) {
	var (
	...
	if r.contactIds == nil {
		return localVarReturnValue, nil, reportError("contactIds is required and must be specified")
	}
	if len(*r.contactIds) < 1 {
		return localVarReturnValue, nil, reportError("contactIds must have at least 1 elements")
	}
	if len(*r.contactIds) > 20 {
		return localVarReturnValue, nil, reportError("contactIds must have less than 20 elements")
	}
...
func (r ApiPutCharactersCharacterIdContactsRequest) Execute() (interface{}, *http.Response, error) {
...
// Execute executes the request
//  @return interface{}
func (a *ContactsAPIService) PutCharactersCharacterIdContactsExecute(r ApiPutCharactersCharacterIdContactsRequest) (interface{}, *http.Response, error) {
	var (
